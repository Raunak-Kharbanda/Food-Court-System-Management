...
public class ben extends JFrame implements ActionListener
{
	float sub;
	...
	public void actionPerformed(ActionEvent ar) 
	{
		...
		if(ar.getSource()==b0)
		{
			JOptionPane.showMessageDialog(null,"Sorry. No offers available at Ben & Jerry's.");
		}
		if(ar.getSource()==b1)
		{
			...
			try
			{
				rs=smt.executeQuery("select * from ben where id='"+t1.getText()+"'");
				if(rs.next())
				{
