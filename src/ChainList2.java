...
public class ChainList2 extends JFrame implements ActionListener
{
	String UName;
	Connection con;
	Statement st;
	...
	public ChainList2(String a)
	{
		...
		add(background);
		l1.setBounds(450,170,500,100);background.add(l1);
