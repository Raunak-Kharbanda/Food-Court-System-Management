...
public class baristabill extends JFrame implements ActionListener 
{
	float a,b,c,d,e,f;
	static float sub;
	float total;
	...
	public baristabill(float g)
	{
		...
		JLabel background=new JLabel(new ImageIcon("G:\\pics\\barista.jpg"));
		add(background);
