...
public class dominosmeal extends JFrame implements ActionListener
{
	float sub;
	...
	public dominosmeal()
	{
		...
		JLabel background=new JLabel(new ImageIcon("G:\\pics\\dominosmeal.jpg"));
		add(background);
	...
	public void actionPerformed(ActionEvent ar) 
	{
		...
		if(ar.getSource()==b1)
		{
			...
			try
			{
				rs=smt.executeQuery("select * from dominosmeal where SNo='"+t1.getText()+"'");
				if(rs.next())
				{
