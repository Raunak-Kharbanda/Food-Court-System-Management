...
public class buffet extends JFrame implements ActionListener
{
	float sub;
	...
	public void actionPerformed(ActionEvent ar) 
	{
		...
		if(ar.getSource()==b0)
		{
			JOptionPane.showMessageDialog(null,"Sorry. No offers available at The Buffet.");
		}
		if(ar.getSource()==b1)
		{
			...
			try
			{
				rs=smt.executeQuery("select * from buffet where id='"+t1.getText()+"'");
				if(rs.next())
				{
