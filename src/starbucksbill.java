...
public class starbucksbill extends JFrame implements ActionListener 
{
	float a,b,c,d,e,f;
	static float sub;
	float total;
	...
	public starbucksbill(float g)
	{
		...
		JLabel background=new JLabel(new ImageIcon("G:\\pics\\starbucks.jpg"));
		add(background);
