...
public class kfcmeal extends JFrame implements ActionListener
{
	float sub;
	...
	public kfcmeal()
	{
		...
		JLabel background=new JLabel(new ImageIcon("G:\\pics\\kfcmeal.jpg"));
		add(background);
	...
	public void actionPerformed(ActionEvent ar) 
	{
		...
		if(ar.getSource()==b1)
		{
			...
			try
			{
				rs=smt.executeQuery("select * from kfcmeal where SNo='"+t1.getText()+"'");
				if(rs.next())
				{
