...
public class dominosbill extends JFrame implements ActionListener 
{
	float a,b,c,d,e,f;
	static float sub;
	float total;
	...
	public dominosbill(float g)
	{
		...
		JLabel background=new JLabel(new ImageIcon("G:\\pics\\dominos.jpg"));
		add(background);
	...
	{
		if(ar.getSource()==b1)    //or... if(ar.getActionCommand().equals("Finish"))
		{
