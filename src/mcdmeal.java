...
public class mcdmeal extends JFrame implements ActionListener
{
	float sub;
	...
	public mcdmeal()
	{
		...
		JLabel background=new JLabel(new ImageIcon("G:\\pics\\mcdmeal.jpg"));
		add(background);
	...
	public void actionPerformed(ActionEvent ar) 
	{
		...
		if(ar.getSource()==b1)
		{
			...
			try
			{
				rs=smt.executeQuery("select * from mcdmeal where SNo='"+t1.getText()+"'");
				if(rs.next())
				{
