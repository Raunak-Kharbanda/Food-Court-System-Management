...
public class pizzahutmeal extends JFrame implements ActionListener
{
	float sub;
	...
	public pizzahutmeal()
	{
		...
		JLabel background=new JLabel(new ImageIcon("G:\\pics\\pizzahutmeal.jpg"));
		add(background);
	...
	public void actionPerformed(ActionEvent ar) 
	{
		...
		if(ar.getSource()==b1)
		{
			...
			try
			{
				rs=smt.executeQuery("select * from pizzahutmeal where SNo='"+t1.getText()+"'");
				if(rs.next())
				{
